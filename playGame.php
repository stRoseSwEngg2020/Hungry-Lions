  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <p>Please click one of the following buttons to play the game with your desired difficulty.</p>
            ...
            <a href="NEWeasy.html" class="btn btn-primary btn-lg btn-block active" role="button">Easy</a>
            <a href="NEWmedium.html" class="btn btn-primary btn-lg btn-block active" role="button">Medium</a>
            <a href="NEWhard.html" class="btn btn-primary btn-lg btn-block active" role="button">Hard</a>
    </div>
  </div>
</div>
</body>
